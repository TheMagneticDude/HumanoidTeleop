...
public class LArmControl : MonoBehaviour
{
    ...
    public string topicName = "/L_arm_pose";
    ...
    private bool TryGetTargetDistance(out Vector3 isaacTarget)
    {
        ...
        var leftHand = m_HandsSubsystem.leftHand;
        if (!leftHand.isTracked) return false;

        var wristJoint = leftHand.GetJoint(XRHandJointID.Wrist);
